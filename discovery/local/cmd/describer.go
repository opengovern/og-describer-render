...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/opengovern/og-describer-render/discovery/pkg/orchestrator"
	"github.com/opengovern/og-describer-render/global"
	"os"
	"strconv"
	"strings"
	"time"
...
// describerCmd represents the describers local
var describerCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		creds, err := provider.AccountCredentialsFromMap(map[string]any{
			"api_key": "rnd_gWCrCNuCbsZSSfz9RCtKG4JzzxiM",
		})
		if err != nil {
